...
Download the datasets from [the course dataset folder](https://drive.google.com/drive/folders/1qjBtPVDepDE22j0axqrLVR0A2a969Qyy?usp=drive_link). Extract `air_quality.zip` and arrange the files as follows:
...
- [Design report](docs/w1_design_report.md) and [4-page PDF](docs/w1_design_report.pdf).
- [Architecture diagram](docs/architecture.pdf) and [Mermaid source](docs/architecture.md).
