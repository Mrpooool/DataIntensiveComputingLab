-- Q3 rebuilt from the air_quality_impact_summary product. Hourly NYC demand comes from the
-- product; the calendar and the two-level PM2.5 median are the canonical definitions.
